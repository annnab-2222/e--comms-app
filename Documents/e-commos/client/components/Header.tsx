...
export default function Header({title, showBack, showCart, showMenu, showLogo, showSearch} : HeaderProps) {
  ...
  return (
    <View className='flex-row items-center justify-between px-4 py-3 bg-white'>
        {/*left side*/}
     <View className='flex-row item-center flex-1'>
        {showBack && (
       ...
       {showMenu && (
        ...
        <Text className='text-x1 font-bold text-primary text-center flex-1 mr-8'> {title} </Text>
         )}
