  ...
  return (
   <SafeAreaView className='flex-1 bg-surface' edges={['top']}>
    ...
    <view className='flex-row gap-2 mb-3 mx-4 my-2'>
      {/* Search bar*/}
       <View className='flex-1 flex-row items-center bg-white rounded-x1 boeder border-gray-100'>
       ...
       {/* filter icon */}
       <TouchableOpacity className='bg-gray-800 w-12 h-12 items-center justify-center rounder-x1'>
